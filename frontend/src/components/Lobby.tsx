...
const Lobby: React.FC<LobbyProps> = ({ onJoin, onCreate, roomId, players, player, onStart, lastPenalty, onLeaveRoom }) => {
                    ...
                    {mode === 'select' && (
                        <div className="flex flex-col gap-4">
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 text-white font-bold py-4 px-4 rounded-xl shadow-[0_0_20px_rgba(220,38,38,0.3)] transition-all active:scale-[0.98]"
                            >
                                Crea Stanza
                            </button>
                            <button
                                onClick={() => setMode('join')}
                                className="w-full bg-neutral-800 hover:bg-neutral-700 border border-white/10 text-white font-bold py-4 px-4 rounded-xl transition-all active:scale-[0.98]"
                            >
                                Unisciti a Stanza
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleCreateSubmit} className="space-y-4">
                            ...
                            <div className="flex gap-2 mt-4">
                                <button
                                    ...
                                    className="w-1/3 bg-neutral-800 hover:bg-neutral-700 text-neutral-300 font-bold py-3.5 px-4 rounded-xl transition-all active:scale-[0.98]"
                                >
                                    Indietro
                                </button>
                                <button
                                    type="submit"
                                    className="w-2/3 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500 text-white font-bold py-3.5 px-4 rounded-xl shadow-[0_0_20px_rgba(220,38,38,0.3)] transition-all active:scale-[0.98]"
                                >
                                    Crea
                                </button>
                            </div>
                ...
                <div className="space-y-6">
                    ...
                    {players.length >= 2 ? (
                        ...
                        <p className="text-center text-sm text-neutral-400 italic">
                            La partita inizierà quando ci saranno almeno 2 giocatori.
                        </p>
                    )}
                </div>
            )}
